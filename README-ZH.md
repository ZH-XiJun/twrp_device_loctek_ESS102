# TWRP device tree for LOCTEK sp7731e_1h10_native (ESS102)

这个设备树由 [twrpdtgen](https://github.com/twrpdtgen/twrpdtgen) 生成

## 下载

点[这里](https://github.com/ZH-XiJun/Action-TWRP-Builder/releases)，然后搜`ESS102`就能找到你的设备了。
...
该设备树相对于源码的存放路径（DEVICE_PATH）：`device/loctek/ESS102`
